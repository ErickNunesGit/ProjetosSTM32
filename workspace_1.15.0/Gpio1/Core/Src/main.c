...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE END WHILE */
	  ...
	  check = HAL_GPIO_ReadPin(GPIOA, bot1_Pin); //Status do pino alocado em variável
	  //if(!HAL_GPIO_ReadPin(GPIOA, bot1_Pin)){ // if diretamente da função HAL
	  if(check==0){ // mesmo if a partir da variável
