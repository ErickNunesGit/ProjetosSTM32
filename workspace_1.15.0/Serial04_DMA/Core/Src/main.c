...
/* USER CODE BEGIN PV */
HAL_UART_StateTypeDef uart_error;
...
{
	if(brx[0] == 'c' && brx[1] == 'h' && brx[2] == 'n' && brx[3] == 'g')
	{
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_Delay(1000);
	  uart_error = HAL_UART_GetError(&huart4);
	  uart_status = HAL_UART_GetState(&huart4);
